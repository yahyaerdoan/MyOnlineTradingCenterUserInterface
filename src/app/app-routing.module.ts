...
const routes: Routes = [
  ...
  {
    path: "blogs", loadChildren: () => import("./user-interface/components/blogs/blogs.module")
      .then(module => module.BlogsModule)
  },
  {
    path: "footers", loadChildren: () => import("./user-interface/components/footers/footers.module")
      .then(module => module.FootersModule)
  },
  {
    path: "headers", loadChildren: () => import("./user-interface/components/headers/headers.module")
      .then(module => module.HeadersModule)
  },
  {
    path: "heros", loadChildren: () => import("./user-interface/components/heros/heros.module")
      .then(module => module.HerosModule)
  },
  {
    path: "populars", loadChildren: () => import("./user-interface/components/populars/populars.module")
      .then(module => module.PopularsModule)
  },
  {
  ...
  {
    path: "testimonials", loadChildren: () => import("./user-interface/components/testimonials/testimonials.module")
      .then(module => module.TestimonialsModule)
  },
  {
    path: "we-helps", loadChildren: () => import("./user-interface/components/we-helps/we-helps.module")
      .then(module => module.WeHelpsModule)
  },
  {
    path: "why-chooses", loadChildren: () => import("./user-interface/components/why-chooses/why-chooses.module")
      .then(module => module.WhyChoosesModule)
  }
];
